...
<head>
	...
	<link  rel="stylesheet" href="/test/Public/css/paper.css"/>
		...
		<div class="row" style="padding-top:0px;">
			...
			<div class="col-md-10 col-lg-9 col-xs-12 col-sm-12" id="body">
				<div class="column" style="padding-top:0px;">
					...
					<form name="fm0" action="/test/Paper/Paper/phone" method="post" id="select" class="form-inline" onsubmit="return check()">
					<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" id="title">
							...
							<a class="a1" href="/test/Paper/Paper/situation">各单位参赛情况</a></p>
